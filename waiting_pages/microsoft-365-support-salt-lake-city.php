...
/**
 * Archived public route wrapper for the inactive `microsoft-365-support-salt-lake-city` page.
 *
...
render_site_page($inactivePages['microsoft-365-support-salt-lake-city']);
