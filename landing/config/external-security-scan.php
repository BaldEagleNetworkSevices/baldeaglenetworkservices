...
return [
    ...
    'page_title' => 'External Exposure Triage | Bald Eagle Network Services',
    'meta_description' => 'External exposure triage for Salt Lake businesses that need fast internet-facing risk visibility after a recovery test or urgent incident concern.',
    'hero_kicker' => 'External Exposure Triage',
    'hero_title' => 'Find the exposure before ransomware does.',
    'hero_intro' => 'This offer is for businesses that need a fast external-facing risk snapshot. Bald Eagle reviews DNS posture, website TLS and headers, email authentication, and visible exposure signals without touching internal systems.',
    'primary_cta' => 'Start External Exposure Triage',
    'secondary_cta' => 'Review Triage Scope',
    'turnstile' => [
    ...
    'pricing' => [
        [
            ...
            'copy' => 'Best fit when you want a clear external exposure review on a normal business timeline.',
            'points' => [
